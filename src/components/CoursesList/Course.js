                ...
                <Row>
                    ...
                    <Col sm={12} md={5}>
                        <div>
                            ...
                            {progress === 0 ? <><p className='course-status mb-0'>{t('course.notStarted')}</p><Button className='course-btn'>{t('actions.startCourse')}</Button></> : <Button className="course-btn mt-3">{t('actions.continueCourse')}</Button>}
                        </div>
                    </Col>
                </Row>
            </NavLink>
